...
export default function CampusStudentHistory() {
  const [formData, setFormData] = useState({
    ...
    // Health
    studentHealth: "",
    // Primary guardian's Health
    primaryGuardianHealth: "",
    poorPrimaryGuardianHealthExplanation: "",
    // Secondary guardian's Health
    secondaryGuardianHealth: "",
    poorSecondaryGuardianHealthExplanation: "",
    // Conditions
    chickenPox: "No",
    diphtheria: "No",
    whoopingCough: "No",
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`http://localhost:8091/api/campusStudentHistory/create`, {
        ...formData,
        isSubmitted: "Yes",
        checkInCode,
      })
  ...
  return (
    <div className="">
      <div className="">
        ...
        <h5 className="mt-3">Primary Guardian's Health</h5>
        <div className="form-check">
          <input
            type="radio"
            className="form-check-input"
            name="primaryGuardianHealth"
            id="goodMotherHealth"
            value="Good"
            checked={formData.primaryGuardianHealth === "Good"}
            onChange={() =>
              setFormData({ ...formData, primaryGuardianHealth: "Good" })
            }
          />
        ...
        <div className="form-check">
          <input
            ...
            id="fairMotherHealth"
            value="Fair"
            checked={formData.primaryGuardianHealth === "Fair"}
            onChange={() =>
              setFormData({ ...formData, primaryGuardianHealth: "Fair" })
            }
          />
        ...
        <div className="form-check">
          <input
            ...
            id="poorMotherHealth"
            value="Poor"
            checked={formData.primaryGuardianHealth === "Poor"}
            onChange={() =>
              setFormData({ ...formData, primaryGuardianHealth: "Poor" })
            }
          />
        ...
        <div className="form-group mt-2">
          <label htmlFor="poorPrimaryGuardianHealthExplanation">
            If poor, explain:
          </label>
          <textarea
            className="form-control"
            id="poorPrimaryGuardianHealthExplanation"
            rows="2"
            value={formData.poorPrimaryGuardianHealthExplanation}
            onChange={(e) =>
              setFormData({
                ...formData,
                poorPrimaryGuardianHealthExplanation: e.target.value,
              })
            }
          ></textarea>
        </div>
        <h5 className="mt-3">Secondary Guardian's Health</h5>
        <div className="form-check">
          <input
            type="radio"
            className="form-check-input"
            name="secondaryGuardianHealth"
            id="goodFatherHealth"
            value="Good"
            checked={formData.secondaryGuardianHealth === "Good"}
            onChange={() =>
              setFormData({ ...formData, secondaryGuardianHealth: "Good" })
            }
          />
        ...
        <div className="form-check">
          <input
            ...
            id="fairFatherHealth"
            value="Fair"
            checked={formData.secondaryGuardianHealth === "Fair"}
            onChange={() =>
              setFormData({ ...formData, secondaryGuardianHealth: "Fair" })
            }
          />
        ...
        <div className="form-check">
          <input
            ...
            id="poorFatherHealth"
            value="Poor"
            checked={formData.secondaryGuardianHealth === "Poor"}
            onChange={() =>
              setFormData({ ...formData, secondaryGuardianHealth: "Poor" })
            }
          />
        ...
        <div className="form-group mt-2">
          <label htmlFor="poorSecondaryGuardianHealthExplanation">
            If poor, explain:
          </label>
          <textarea
            className="form-control"
            id="poorSecondaryGuardianHealthExplanation"
            rows="2"
            value={formData.poorSecondaryGuardianHealthExplanation}
            onChange={(e) =>
              setFormData({
                ...formData,
                poorSecondaryGuardianHealthExplanation: e.target.value,
              })
            }
          ></textarea>
        </div>
        ...
        <div className="form-check">
          <input
            ...
            className="form-check-input"
            id="addAdhdCondition"
            checked={formData.addAdhdCondition === "Yes"}
            onChange={() =>
              setFormData({
                ...formData,
                addAdhdCondition:
                  formData.addAdhdCondition === "Yes" ? "No" : "Yes",
              })
            }
          />
          <label className="form-check-label" htmlFor="addAdhdCondition">
            ADD/ADHD
          </label>
        </div>
        <div className="form-check">
